...
export const aboutParagraphs = [
  ...
  "מזמינה אתכם לצאת איתי למסע מופלא בו תוכלו להכיר, לגלות ולאהוב את עצמכם מחדש, לדייק, לחזק ולקדם את בחירותיכם והחלטותיכם, נדבר על מה שהכי בוער בכם כעת, בנושאים שונים בחייכם וכל זאת מתוך הקשבה, דיוק ורגישות.",
